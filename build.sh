...
then
    ...
    g++.exe -std=c++17 -static-libstdc++ -static-libgcc -I"include/" -I"third-party/toolbox/" -I"C:\MinGW\include" -L"lib/" -L"C:\MinGW\lib" src/main.cpp -o build/src/main.out build/src/Engine.o build/src/utils.o -lpthread -lmingw32 -lSDL2main -lSDL2
